...
function Addcourse() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post('http://localhost:8080/api/Admin/addcourse', values)
      .then((res) => {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <input
                ...
                placeholder="Enter number of students enrolled for the course"
                autoComplete="off"
                onChange={handleInput}
              />
            </div>
            ...
            <div className="mb-3">
              <button type="submit" id="addCourse" className="btn btn-success w-10">
                Add course
              </button>
            </div>
          </form>
